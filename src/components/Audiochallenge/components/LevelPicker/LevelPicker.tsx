...
import { NUM_OF_QUESTIONS, setAnswersSet, setWordsByLevel, startChallengeByLevel } from '../../../../redux/features/audioChallengeSlice';

const LevelPicker: FC = () => {
  const challengeLevels = ['Beginner', 'Pre-Intermediate', 'Intermediate', 'Upper-Intermediate', 'Advanced', 'Profiency'];
